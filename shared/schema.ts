import { pgTable, serial, varchar, integer, timestamp, text, real, boolean, index, uniqueIndex, jsonb } from 'drizzle-orm/pg-core';
...
export const football_player_statistics = pgTable('football_player_statistics', {
  ...
  passes_accuracy: real('passes_accuracy'),
  ...
  dribbles_success: real('dribbles_success'),
